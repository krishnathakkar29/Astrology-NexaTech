...
export default function PalmistryPage() {
  const t = useTranslations("services.palmistry");
  return (
    <>
      {/* Hero Section */}
      <section
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              {" "}
              {/* Palm Lines - Map through translation items */}
              {[0, 1, 2, 3].map((index) => (
                <div
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-slate-800 mb-2">
                        {t(`lines.items.${index}.name`)}
                      </h3>
                      <p className="text-slate-600 mb-2">
                        {t(`lines.items.${index}.description`)}
                      </p>
                      <p className="text-rose-400 text-sm">
                        {t(`lines.items.${index}.note`)}
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 text-white" style={{ background: "#280F43" }}>
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* What's Included Features - Map through translation items */}
            {[0, 1, 2, 3].map((index) => (
              <div
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-4">
                  {t(`included.items.${index}.title`)}
                </h3>
                <p className="text-white/80 leading-relaxed">
                  {t(`included.items.${index}.description`)}
                </p>
              </div>
            ))}
          </div>
