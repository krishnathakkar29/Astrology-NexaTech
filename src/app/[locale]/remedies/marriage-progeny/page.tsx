...
export default function MarriageProgenyPage() {
  const t = useTranslations("remedies.marriageProgeny");
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            {" "}
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-slate-800">
              {t("specializedAreas.title")}
            </h2>
            <p className="text-slate-600 text-lg max-w-3xl mx-auto">
              {t("specializedAreas.subtitle")}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-serif font-bold mb-4 text-slate-800">
                {t("specializedAreas.categories.0.title")}
              </h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                {t("specializedAreas.categories.0.description")}
              </p>
              <ul className="space-y-3">
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.0.features.0")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.0.features.1")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.0.features.2")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-serif font-bold mb-4 text-slate-800">
                {t("specializedAreas.categories.1.title")}
              </h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                {t("specializedAreas.categories.1.description")}
              </p>
              <ul className="space-y-3">
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.1.features.0")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.1.features.1")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.1.features.2")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-serif font-bold mb-4 text-slate-800">
                {t("specializedAreas.categories.2.title")}
              </h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                {t("specializedAreas.categories.2.description")}
              </p>
              <ul className="space-y-3">
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.2.features.0")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.2.features.1")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.2.features.2")}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-serif font-bold mb-4 text-slate-800">
                {t("specializedAreas.categories.3.title")}
              </h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                {t("specializedAreas.categories.3.description")}
              </p>
              <ul className="space-y-3">
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.3.features.0")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.3.features.1")}
                </li>
                <li className="flex items-center text-slate-600">
                  <div className="w-2 h-2 bg-rose-300 rounded-full mr-3"></div>
                  {t("specializedAreas.categories.3.features.2")}
                </li>
              </ul>
            </div>
          </div>
